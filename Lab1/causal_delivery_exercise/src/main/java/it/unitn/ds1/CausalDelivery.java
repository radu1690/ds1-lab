...
public class CausalDelivery {
  ...
  public static void main(String[] args) {
    ...
    // COMPLETED 1: create additional actors in a different conversation
    // the second two peers will be participating in a conversation
    group.add(system.actorOf(
    ...
    //COMPLETED 1: tell the second group to start conversation
    //tell the second group chatter to start conversation
